...
/*   Updated: 2025/02/06 17:37:25 by mpietrza         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class ClapTrap
{
	protected:
		...
		signed int	_hitPoints;
		signed int	_energyPoints;
		signed int	_attackDamage;
		signed int	_repairPoints;
	...
	public:
		...
		signed int 	getAttackDamage() const;
		signed int	getEnergyPoints() const;
		signed int	getRepairPoints() const;
