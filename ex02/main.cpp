...
/*   Updated: 2025/02/05 17:02:01 by mpietrza         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	...
	int clapTrapAttackDamage = getValidIntegerInput("ClapTraps's attack damage: \033[32mhit points\033[0m the enemy will lose when attacked: ");
	...
	int fragTrapRepairPoints = getValidIntegerInput("FragTrap's amount of \033[32mhit points\033[0m each time it repairs: ");
	...
	while (clapTrap.getHitPoints() >= 0 || scavTrap.getHitPoints() >= 0 || fragTrap.getHitPoints() >= 0)
	{
